  ...
  return (
    ...
    >
      ...
      >
          ...
          {!activePC?.models || activePC.models.length === 0 ? (
            ...
            pcTiers.map(t => {
              ...
              return (
                <div
                  key={t.id}
                  className={`flex items-center gap-3 p-[10px_16px] transition-colors ${isComputing && !isSelected
        ...
        <div
          className={`flex items-center justify-between p-[11px_16px] transition-colors ${isComputing
        ...
        <div className="flex flex-col">
          {modes.map(m => {
            ...
            return (
              <div
                key={m.id}
                className={`flex items-center gap-3 p-[10px_16px] transition-colors ${isUnavailable
                    ...
                    {tierModels.map(model => {
                      ...
                      return (
                        <motion.div
                          ...
                          key={model.id}
                          className={`group relative p-[12px_14px] rounded-[10px] transition-colors flex justify-between items-center ${model.isActive
                              ? 'bg-[#1E1E1E]'
                              : 'bg-transparent'
                            }`}
            ...
            return (
              <div key={dm.id} className="bg-bg-surface border border-borders rounded-[12px] p-[14px_16px] flex flex-col relative overflow-hidden">
                ...
                <div className="flex justify-between items-end mt-3">
                  <span className={`font-mono text-[9px] uppercase tracking-[0.1em] ${dm.tier === 'fast' ? 'text-accent' :
