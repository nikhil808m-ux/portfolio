...
const CaseStudyLayout = ({ hasStarted, setHasStarted }: { hasStarted: boolean, setHasStarted: (v: boolean) => void }) => {
  ...
  return (
    <section className="relative w-full bg-transparent py-16 lg:py-24 flex items-center justify-center font-sans">
      <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-[1920px] px-6 sm:px-12 gap-12 lg:gap-24 mx-auto">
      ...
      >
        ...
        >
          {/* Glow effect behind the phone removed as requested */}
          <AppMockup />
        </div>
      </div>
