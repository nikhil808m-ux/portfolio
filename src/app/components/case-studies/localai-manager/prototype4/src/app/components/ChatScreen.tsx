      ...
      >
        ...
        <div className="max-w-[82%] w-full flex flex-col items-end">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <button 
              className={`w-[28px] h-[28px] rounded-full bg-bg-elevated border border-accent-border flex items-center justify-center text-accent transition-colors ${
                editVal.trim().length === 0 ? 'opacity-30 cursor-not-allowed pointer-events-none' : 'hover:bg-accent hover:text-bg-primary'
              }`}
